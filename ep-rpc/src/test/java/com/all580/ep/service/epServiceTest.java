...
//        list.add(1151);
//        print(epService.selectCreatorEpId(1).get()+"     1139");
//        epService.updateEpGroup(1151,"test",list);
...
//        System.out.println(coreEpChannelService.selectPlatfromRate(1145,11319).get()+"         ***");
//    }
//
//    @Test
