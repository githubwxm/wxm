...
import com.framework.common.mns.NewMessageManager;
...
public class SmsServiceImpl implements SmsService {
    ...
    private Map<String, NewMessageManager> mnsMessageMap = new HashMap<>();
    ...
    public Result<?> send(int epId, int type, Map<String, String> params, String... phones) {
        ...
        return send(epId, smsTmpl, params, phones);
    }
    ...
    private Result<String> send(int epId, SmsTmpl tmpl, Map<String, String> params, String... phones) {
        if(smsSend.equals("0")) {
            return new Result<>(true);
        }
