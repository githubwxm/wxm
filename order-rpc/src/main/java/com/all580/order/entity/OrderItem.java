...
public class OrderItem implements Serializable {
     ...
     * 所属表字段为 t_order_item.pro_sub_ticket_type
     */
    private Integer pro_sub_ticket_type;

    /**
     * 票务产品ID
     * 所属表字段为 t_order_item.ma_product_id
     */
...
3-到付
    ...
    /**
     * 所属表字段为 t_order_item.memo
     */
    private String memo;

    /**
     * 重发最大次数
     * 所属表字段为 t_order_item.resend_max_times
     */
    private Integer resend_max_times;

    /**
     * 重发次数
     * 所属表字段为 t_order_item.resend_times
     */
    private Integer resend_times;

    /**
     * 重发间隔(秒)
     * 所属表字段为 t_order_item.resend_interval
     */
    private Integer resend_interval;

    /**
     * 最后重新出票时间
     * 所属表字段为 t_order_item.last_resend_time
     */
     ...
     *
     * @mbggenerated Tue Mar 07 17:04:41 CST 2017
     */
