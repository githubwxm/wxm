...
=======
    fnr.request.hotelSalesList = function(params,options){ return fnr.ajaxJson('/voucher/api/local/core/product/hotel/can_sale/list',params,options); };
    fnr.request.hotelDetailList = function(params,options){ return fnr.ajaxJson('/voucher/api/local/core/product/hotel/sub/can_sale/list',params,options); };
    fnr.request.buyHotelTicked = function(params,options){ return fnr.ajaxJson('/voucher/api/local/core/order/hotel/create',params,options); };
    fnr.request.queryStockAndPrice = function(params,options){ return fnr.ajaxJson('/voucher/api/local/core/product/hotel/stock_price',params,options); };
    fnr.request.buyHotelGroupTicked = function(params,options){ return fnr.ajaxJson('/voucher/api/local/core/order/hotel/group/create',params,options); };
>>>>>>> fix_master
});