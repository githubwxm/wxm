    ...
    var Util = {
        ...
        getmeta: function(name) {
            ...
            for(var i = 0, _item; _item = _metas[i++];){
                if(_item.getAttribute('name') != undefined && _item.getAttribute('name').toLowerCase() === name){
        ...
        getElement: function(selector){
            ...
            if(selector.charAt(0) === '#'){
                var xxoo = selector.substring(1);
                _node = document.getElementById(xxoo);
            } else {
    ...
    function iShare(options) {
        ...
        if((this.config.isAbroad === void(0))){
            ...
            if(this.config.isAbroad){
                ...
                this.config.sites = ['iShare_weibo','iShare_qq','iShare_qzone',];
            }
        }
