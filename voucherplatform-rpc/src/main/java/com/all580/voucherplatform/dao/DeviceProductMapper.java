...
public interface DeviceProductMapper {
    ...
    List<Map> selectProdList(@Param("groupId") Integer groupId, @Param("supplyId") Integer supplyId, @Param("record_start") Integer recordStart, @Param("record_count") Integer recordCount);
}